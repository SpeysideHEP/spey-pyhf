...
from spey import get_backend, StatisticalModel
...
class FullStatisticalModel(PyhfInterface):
    ...
    def combine(self, other, **kwargs) -> StatisticalModel:
        ...
        return get_backend(self.name)(
            signal_patch=new_signal_patch,
            background_only_model=dict(combined_workspace),
            analysis="__combined_model__",
        )
